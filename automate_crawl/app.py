...
class batch_crawling:
    ...
    def handle_all_threads(self, starting_links, crawl_depth, total_threads):
        ...
        bot.store_json(content=all_links, path='files_bot', file_name='all_url.json')
...
bc=batch_crawling()
surl=bc.get_starting_urls('./files_bot/111.json','link')
# print(surl)
th=bc.get_n_threads(5)
print(th)
bc.handle_all_threads(surl,3,35)
