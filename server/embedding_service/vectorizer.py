"""Logical blockk that performs the actual embedding task."""
...
from config import SENTENCE_TRANSFORMER_MODEL, MAX_CONCURRENT_TASKS
...
def vectorize_query(sentence: str) -> List[float]:
    """Accept sentence and convert them to vector."""
